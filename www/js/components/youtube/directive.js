...
.directive('myYoutube', function($sce) {
  return {
    ...
    scope: { code:'=' },
    replace: true,
    template: '<div style="height:350px;"><iframe style="overflow:hidden;height:100%;width:100%" width="100%" height="100%" ng-src="{{url}}" frameborder="0" type="application/x-shockwave-flash" allowfullscreen="true" allowScriptAccess="always"></iframe></div>',
    link: function (scope) {
        console.log('here');
